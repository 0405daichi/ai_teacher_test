    ...
    cardBody.addEventListener('click', (event) => {
      ...
      .then(data => {
        if (cardContentModal._isShown !== true) {
          ...
          const answers = [
            { content: data.answer_1, element: '.answer-1', defaultText: "No answer for type 1" },
            { content: data.answer_2, element: '.answer-2', defaultText: "No answer for type 2" },
            { content: data.answer_3, element: '.answer-3', defaultText: "No answer for type 3" }
          ];
